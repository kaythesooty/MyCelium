...
export default function Fungipedia() {
  ...
  return (
    <div className='flex h-[600px] w-[800px] bg-[url("/book.png")] bg-contain p-6'>
      {currentPage === 0 || currentPage === 1 ? (
        <>
          <div className="mt-10 flex-1 pl-5">
            <h1 className="text-brown-800 font-medieval pb-16 text-center text-3xl">
        ...
        <>
          <div className="font-medieval flex gap-12 pl-12">
            {currentPage === 2 && (
              <>
          ...
          <div className="font-medieval flex gap-12 pl-10">
            {type === 'mushroom' && (
              <>
